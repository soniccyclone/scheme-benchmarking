...
(library (sonic regs)
  ...
  (define-record-type (arch make-arch arch?)
    (fields name value raw float structural))
  ...
  (define arch-x86-64
    (make-arch 'x86-64
      ...
      '(xmm0 xmm1 xmm2 xmm3 xmm4 xmm5 xmm6 xmm7
        xmm8 xmm9 xmm10 xmm11 xmm12 xmm13 xmm14 xmm15)  ; float: 16
  ...
  (define arch-rv64
    (make-arch 'rv64
      ...
      '(t0 t1 t2 s8 s9 s10 s11 t3 t4 t5 t6)         ; raw: 11
      '(ft0 ft1 ft2 ft3 ft4 ft5 ft6 ft7
        fs0 fs1 fs2 fs3 fs4 fs5 fs6 fs7
        fa0 fa1 fa2 fa3 fa4 fa5 fa6 fa7
        fs8 fs9 fs10 fs11 ft8 ft9 ft10 ft11)        ; float: 32
  ...
  (define (reg-class a r)
    (cond ((memq r (arch-value a)) 'value)
