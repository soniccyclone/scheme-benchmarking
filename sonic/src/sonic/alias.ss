...
(library (sonic alias)
  ...
  ;; is indistinguishable from a real one. Here it raised rather than answering emptily --
  ;; "unrecognized language record" -- which is the better failure of the two
  ;; but still means alias analysis had never run on a real program.
  ;;
